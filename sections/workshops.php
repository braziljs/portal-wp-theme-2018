<!-- WEEKLY CONTENT -->
<div class="workshops-wrapper__top" id="workshops">
	<div class="content">
    <div class="center-elements--mobile">
      <h2 class="title--type-2">Workshops BrazilJS</h2>
    </div>
    <ul class="workshops-list-container">
      <li>
      ...
      <li>
        ...
        <div class="paragraph paragraph--color-2">
          ...
          A, e lembre-se de levar seu computador para fazer os exercícios e exemplos.<br/>
          <br/>
          <strong>QUANDO:</strong> Dia 23 de Agosto, à tarde(13:30h).<br/>
          <strong>ONDE:</strong> Decision/FGV, Av. Praia de Belas, 1212, 4º andar, sala 401.<br/>
...
<style>
  .workshops-wrapper__top {
    margin-bottom: 50px;
  }
  .workshops-wrapper__top li {
    display: block;
    clear: both;
    margin-top: 10px;
    margin-bottom: 40px;
  }
  .workshops-wrapper__top li:not(:last-child) {
    border-bottom: solid 1px #999;
  }
  .workshops-wrapper__top img {
    width: 100px;
    outline: solid 3px #ffee1f;
    float: left;
    margin-bottom: 20px;
  }
  .workshops-wrapper__top .paragraph {
    padding-left: 130px;
  }
  .ws-button-container {
    display: flex;
